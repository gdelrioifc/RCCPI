...
//System.err.println(pep_ini+":"+score+":"+largest);
             if(score>=largest)  
              {
//System.err.println("Satisfied >= largest");
               largest=score;
   ...
   try
    {
     ...
     if(best_peptides.size()>0)
      {
//System.err.println("Ya termine de calcular, ahora empiezo a imprimir los "+hits+" de entre los "+best_peptides.size()+" encontrados.");
       ...
       outfile.flush();
       outfile.close();
//System.err.println("Ya termine de imprimir");
      }
    }
   catch(Exception e)
    {
