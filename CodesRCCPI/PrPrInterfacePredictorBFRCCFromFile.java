...
//     executor.shutdown();
   ...
   else
    {
     ...
     System.err.println("<pdb> the name of a file in PDB format; e.g., 5dnk.pdb.");
     ...
     System.err.println("To visualize these results on PyMol, type:");
     System.err.println("select intB1, resi 180-189 in chain B");
     System.err.println("for each hit reported.");
     System.err.println("");
     System.err.println("");
    }
  }
